...
public class C02_Arrays {
    public static void main(String[] args) {
        ...
        // array' in icindeki indexi kullanarak elementlere ulasabilr ve update edebiliriz

        int arr2[]= new int[4];
        System.out.println(arr2[1]); //0
        System.out.println(arr2[3]); //0
        //System.out.println(arr2[5]); //ArrayIndexOutOfBoundsException(sinirlarin disina cikiyorsun)

        // Array' in tamamini yazdirmak istersek

        System.out.println(arr2); // [I@6276ae34
                                    // array'lar non-primitive olduklarindan direk yazdirmak
